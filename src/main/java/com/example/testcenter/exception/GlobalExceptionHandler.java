package com.example.testcenter.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleMissingParams(MissingServletRequestParameterException ex) {
        ...
        return ResponseEntity.badRequest().body(new ErrorMessage(String.format("%s parameter is missing", parameter)));
    }
    ...
    public ResponseEntity<ErrorMessage> handleNotValid(MethodArgumentNotValidException ex) {
